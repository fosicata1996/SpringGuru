...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>
{
	...
	private List<Recipe> getRecipes()
	{
		...
		if (!eachUomOptional.isPresent() || !tableSpoonUomOptional.isPresent() || !teaSpoonUomOptional.isPresent() ||
				!dashUomOptional.isPresent() || !pintSpoonUomOptional.isPresent() || !cupsSpoonUomOptional.isPresent())
		{
